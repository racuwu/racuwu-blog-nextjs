...
export default function FeaturedPost({ post }: { post: Post }) {
    return <div className="border-2 md:border-0 mt-8 md:mt-0 hover:bg-gray-50 p-4 rounded-lg cursor-pointer">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4">
                ...
                <p className="text-gray-500 w-5/6 animate__animated animate__fadeInDown" dangerouslySetInnerHTML={{ __html: post.excerpt }}></p>
                <Link href={`/posts/${post.slug}`}><button className="bg-pink-700 text-white px-4 py-2 rounded-lg my-4 animate__animated animate__bounceIn">Read Full Story</button></Link>
